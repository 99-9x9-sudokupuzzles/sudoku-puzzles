...
(function(){
'use strict';
const PUZZLE = [0, 0, 0, 8, 0, 3, 0, 0, 0, 8, 0, 0, 0, 0, 0, 0, 0, 1, 7, 0, 0, 0, 0, 0, 0, 0, 6, 0, 0, 0, 9, 0, 5, 0, 0, 0, 0, 1, 9, 0, 0, 0, 2, 4, 0, 0, 0, 5, 2, 0, 6, 3, 0, 0, 0, 8, 0, 3, 0, 9, 0, 6, 0, 0, 0, 7, 0, 0, 0, 1, 0, 0, 0, 4, 6, 1, 2, 7, 9, 8, 0];
const SOLUTION = [1, 6, 4, 8, 7, 3, 5, 2, 9, 8, 9, 3, 5, 6, 2, 4, 7, 1, 7, 5, 2, 4, 9, 1, 8, 3, 6, 3, 2, 8, 9, 4, 5, 6, 1, 7, 6, 1, 9, 7, 3, 8, 2, 4, 5, 4, 7, 5, 2, 1, 6, 3, 9, 8, 2, 8, 1, 3, 5, 9, 7, 6, 4, 9, 3, 7, 6, 8, 4, 1, 5, 2, 5, 4, 6, 1, 2, 7, 9, 8, 3];
const PUZZLE_NUM = 12;
