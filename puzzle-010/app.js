...
(function(){
'use strict';
const PUZZLE = [1, 0, 6, 7, 0, 5, 4, 0, 9, 0, 0, 0, 0, 0, 0, 0, 0, 0, 8, 0, 2, 0, 4, 0, 7, 0, 1, 0, 7, 0, 8, 0, 9, 0, 4, 0, 6, 0, 0, 0, 0, 0, 0, 0, 5, 0, 0, 0, 0, 0, 0, 0, 0, 0, 4, 8, 0, 2, 0, 6, 0, 3, 7, 7, 0, 0, 0, 8, 0, 0, 0, 4, 0, 1, 0, 0, 7, 0, 0, 6, 0];
const SOLUTION = [1, 3, 6, 7, 2, 5, 4, 8, 9, 5, 4, 7, 9, 1, 8, 3, 2, 6, 8, 9, 2, 6, 4, 3, 7, 5, 1, 3, 7, 1, 8, 5, 9, 6, 4, 2, 6, 2, 8, 4, 3, 7, 9, 1, 5, 9, 5, 4, 1, 6, 2, 8, 7, 3, 4, 8, 5, 2, 9, 6, 1, 3, 7, 7, 6, 3, 5, 8, 1, 2, 9, 4, 2, 1, 9, 3, 7, 4, 5, 6, 8];
const PUZZLE_NUM = 10;
